...
BEGIN
    EXECUTE IMMEDIATE 'CREATE ROLE SUPERVISOR_ROLE';
    DBMS_OUTPUT.PUT_LINE('Role SUPERVISOR_ROLE created successfully.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Role SUPERVISOR_ROLE already exists or another error occurred: ' || SQLERRM);
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE ROLE INVENTORY_MANAGER_ROLE';
    DBMS_OUTPUT.PUT_LINE('Role INVENTORY_MANAGER_ROLE created successfully.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Role INVENTORY_MANAGER_ROLE already exists or another error occurred: ' || SQLERRM);
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE ROLE SALES_MANAGER_ROLE';
    DBMS_OUTPUT.PUT_LINE('Role SALES_MANAGER_ROLE created successfully.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Role SALES_MANAGER_ROLE already exists or another error occurred: ' || SQLERRM);
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE ROLE SUPPLIER_MANAGER_ROLE';
    DBMS_OUTPUT.PUT_LINE('Role SUPPLIER_MANAGER_ROLE created successfully.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Role SUPPLIER_MANAGER_ROLE already exists or another error occurred: ' || SQLERRM);
END;
/
...
BEGIN
    EXECUTE IMMEDIATE 'CREATE ROLE INVENTORY_USER_ROLE;';
    DBMS_OUTPUT.PUT_LINE('Role INVENTORY_USER_ROLE; created successfully.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Role INVENTORY_USER_ROLE; already exists or another error occurred: ' || SQLERRM);
END;
/
...
GRANT INVENTORY_MANAGER_ROLE TO INVENTORY_MANAGER_USR;
GRANT CONNECT TO INVENTORY_MANAGER_USR;

CREATE USER SALES_MANAGER_USR IDENTIFIED BY "SalesM@nager2023#";
GRANT SALES_MANAGER_ROLE TO SALES_MANAGER_USR;
GRANT CONNECT TO SALES_MANAGER_USR;

CREATE USER SUPPLIER_MANAGER_USR IDENTIFIED BY "SupM@nager2023#";
GRANT SUPPLIER_MANAGER_ROLE TO SUPPLIER_MANAGER_USR;
GRANT CONNECT TO SALES_MANAGER_USR

CREATE USER INVENTORY_USER_USR IDENTIFIED BY "InvUs3r2023#";
GRANT INVENTORY_USER_ROLE TO INVENTORY_USER_USR;
GRANT CONNECT TO SALES_MANAGER_USR
