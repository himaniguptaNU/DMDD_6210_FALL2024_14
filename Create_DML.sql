...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Error during truncation: ' || SQLERRM);
    END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Error resetting sequences: ' || SQLERRM);
    END;
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Supplier table: ' || SQLERRM);
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Product table: ' || SQLERRM);
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Warehouse table: ' || SQLERRM);
        END;
        ...
        EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Customer table: ' || SQLERRM);
        END;
    ...
    EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Warehouse_Product table: ' || SQLERRM);
    END;
    ...
    --Inventory_Transfer
       ...
       EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Inventory_Transfer table: ' || SQLERRM);
        END;
       ...
       EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Customer_Order table: ' || SQLERRM);
        END;
     ...
     EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Order_Details table: ' || SQLERRM);
      END;
        -- Supplier_Product
    BEGIN
    ...
    EXCEPTION
            WHEN OTHERS THEN
                DBMS_OUTPUT.PUT_LINE('Error inserting into Supplier_Product table: ' || SQLERRM);
        END;

    EXCEPTION
        WHEN OTHERS THEN
            DBMS_OUTPUT.PUT_LINE('Error during data insertion process: ' || SQLERRM);
    END;
